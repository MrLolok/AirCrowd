...
public abstract class AbstractKafkaStreamsProvider implements KafkaStreamsProvider {
    ...
    public void start() {
        ...
        if (this.streams != null) this.streams.start();
    ...
    private Properties getProperties() {
        ...
        props.put(
                ...
                KAFKA_SETTINGS.consumer().enableAutocommit());
        props.put(ConsumerConfig.GROUP_ID_CONFIG, KAFKA_SETTINGS.consumer().groupId());
        props.put(
                ConsumerConfig.AUTO_OFFSET_RESET_CONFIG,
                KAFKA_SETTINGS.consumer().autoOffsetReset());
        props.put(
                ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG,
                KAFKA_SETTINGS.consumer().keyDeserializer());
        props.put(
                ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
                KAFKA_SETTINGS.consumer().valueDeserializer());
        return props;
    }
}
